...
namespace Prestaciones.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class PrestacionesAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private Prestaciones.Module.PrestacionesModule module3;
        private Prestaciones.Module.Web.PrestacionesAspNetModule module4;
        ...
        public PrestacionesAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void PrestacionesAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new Prestaciones.Module.Web.PrestacionesAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.PrestacionesAspNetApplication_DatabaseVersionMismatch);
